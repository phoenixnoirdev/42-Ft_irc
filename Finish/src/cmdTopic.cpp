...
void Server::handleTopic(User& user, const std::string& line)
{
    ...
    std::cout << RED << "[TOPIC]: " << chanName << " " << user.getName() << " tried to use the TOPIC command." << RESET << std::endl;
...
void Server::handleTopicAff(User& user, const std::string& line)
{
    ...
    std::cout << CYAN << "[TOPIC]: " << chanName << " " << user.getName() << " requested the topic." << RESET << std::endl;
...
void Server::EdtiTopic(Channel& chan, std::string chanName, size_t sp2, std::string tmp, User& user)
{
    ...
    std::cout << CYAN << "[TOPIC]: " << chanName << " " << user.getName() << " changed the TOPIC to: " << topic << RESET << std::endl;
